...
Balloon::Balloon(Texture &texture_, Vector2f position_, Vector2i v_dir_, float speed_, int point_, Texture &frozen_texture_) : texture(texture_), position(position_), v_dir(v_dir_), speed(speed_), point(point_), frozen_texture(frozen_texture_)
{
